...
public class CourseDaoImpl implements CourseDao {
	...
	public List<Course> getPrerequisites(String courseNo){
		...
		Course p;
		String findAllPrerequisites="select PrerequisitesNo from prerequisites where courseNo='"+courseNo+"'";
		Connection Conn = DbUtil.getSqliteConnection();
		try {
	...
	public void updateCourseprerequisites(Course precourse,Course course) {
		...
		Connection Conn = DbUtil.getSqliteConnection();
		String updatePrerequisites = "update prerequisites set PrerequisitesNo=? where courseNo='"+course.getCourseNo()+"'";
		try {
	...
	public void addCourseprerequisites(Course precourse,Course course) {
		...
		Connection Conn = DbUtil.getSqliteConnection();
		String addPrerequisites = "insert into prerequisites(PrerequisitesNo,courseNo) values(?,?)";
		try {		
	...
	public void deleteCourseprerequisites(String courseNo){
		...
		Connection Conn = DbUtil.getSqliteConnection();
		String deleteCourseprerequisites = "delete from prerequisites where courseNo='"+courseNo+"'";
		try {
